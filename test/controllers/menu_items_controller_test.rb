...
class MenuItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create menu_item" do
    assert_difference('MenuItem.count') do
      post menu_items_url, params: { menu_item: { menu_id: @menu_item.menu_id, menu_item_name: @menu_item.menu_item_name, menu_item_price: @menu_item.menu_item_price } }
    end
  ...
  test "should update menu_item" do
    patch menu_item_url(@menu_item), params: { menu_item: { menu_id: @menu_item.menu_id, menu_item_name: @menu_item.menu_item_name, menu_item_price: @menu_item.menu_item_price } }
